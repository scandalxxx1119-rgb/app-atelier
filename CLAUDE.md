...
| パート | 時間 | 内容 |
|--------|------|------|
| フック | 0〜8秒 | 具体的な場面・状況から入る（「〇〇って経験ない？」など）。アプリ名から始めない |
| 問題の深掘り | 8〜18秒 | そのシーンの不満・困りごとを掘り下げる |
| アプリ登場 | 18〜28秒 | アプリ名と何をするものか一言で |
| 感動ポイント | 28〜38秒 | 一番刺さる機能・体験を具体的に |
| 締め | 38〜45秒 | アプリ名 + 「App Atelierで調べてみて」 |

**トーン:** カジュアル・友達に話しかける口調。「です・ます」ベースだがかたくならない。

**禁止:** 「〇〇というアプリを紹介します」から始めない。機能の羅列しない。「便利です」だけで終わらせない。
